...
async function createFooterImage(footerInfo, width, bgColor) {
  ...
  <body>
    <div class="footer">
      <div class="wrapper">
        <img src="${footerInfo.logoBase64 ||"https://pngimagesfree.com/wp-content/uploads/CA-Logo-PNG-HD@."}" alt="" style="height:90vh; margin:5px;"/>
        <div class="info">
          <div class="info-wrap">
            <svg
              width="35px"
...
async function addFooterToImage(imageBuffer, footerInfo, bgColor) {
  try {
    ...
    const footerBuffer = await createFooterImage(footerInfo, width, bgColor);
